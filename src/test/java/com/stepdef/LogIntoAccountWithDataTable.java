...
public class LogIntoAccountWithDataTable {
	...
	public void user_enters_valid_username(DataTable userName) throws Throwable {

	    List<List<String>> data = userName.raw();
	    color.drawBorder(obj.getEmailAddress(), "red");
			obj.getEmailAddress().sendKeys(data.get(0).get(1));
	    
	}

	@When("^User enters valid password$")
	public void user_enters_valid_password(DataTable password) throws Throwable {

		List<List<String>> data = password.raw();
	  	color.drawBorder(obj.getPassword(), "blue");
			obj.getPassword().sendKeys(data.get(0).get(1));
